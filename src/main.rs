...
fn print_training_progress(started: Instant, event: &TrainingProgress) {
    ...
    match event {
        ...
        TrainingProgress::SelfPlayFinished {
            ...
            eprintln!(
                "[{elapsed}] self-play finished: evaluator={evaluator:?}, {games} games ({restarted_games} targeted restarts), {examples} examples, absolute first/second/draw={}/{}/{}, mover starter/non-starter/unclassified={}/{}/{}",
                outcomes.first_wins,
        ...
        TrainingProgress::SelfPlayResumed {
            ...
            "[{elapsed}] self-play resumed from {games} persisted games generated by {evaluator:?} ({restarted_games} targeted restarts, {examples} examples); generation will not be duplicated"
        ),
...
fn print_generation_report(report: &yokai::GenerationReport) {
    println!(
        "generation={} source_champion={} self_play_source={} self_play_evaluator={:?} promoted={} games={} restarted_games={} buffer_examples={} terminal_window={:?} terminal_extra_examples={} terminal_oversampling={}",
